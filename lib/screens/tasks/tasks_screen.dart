...
class _TasksScreenState extends State<TasksScreen> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: _isLoading
          ...
          : Column(
              children: [
                if (totalCount > 0)
                  _TaskProgressBar(done: doneCount, total: totalCount),
                Expanded(
                  child: TabBarView(
                    controller: _tabController,
                    children: [
                      _TaskList(
                        ...
                        emptySubtitle: isArchived ? 'This trip is archived.' : 'Tap the button below to add a task.',
                        buttonLabel: isArchived ? null : 'Add Task',
                        onButtonPressed: isArchived ? null : _addTask,
                        onEdit: _editTask,
                      ...
                      _TaskList(
                        ...
                        emptySubtitle: 'Move a pending task to in-progress.',
                        onEdit: _editTask,
                        onDelete: _deleteTask,
                        onStatusChange: _changeStatus,
                      ),
  ...
  Future<void> _addTask() async {
    final result = await showDialog<bool>(
      context: context,
      builder: (_) => _AddEditTaskDialog(tripId: widget.trip.id),
    );
  ...
  Future<void> _editTask(TripTask task) async {
    final result = await showDialog<bool>(
      context: context,
      builder: (_) => _AddEditTaskDialog(tripId: widget.trip.id, task: task),
    );
    if (result == true) _load();
  }
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text('Task Progress', style: Theme.of(context).textTheme.titleSmall),
...
class _TaskList extends StatelessWidget {
  ...
  final Function(TripTask) onEdit;
  final Function(TripTask) onDelete;
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: task.isDone
                        ? Icon(Icons.check, size: 14, color: _statusColor)
                        : task.status == TaskStatus.inProgress
                            ? Icon(Icons.timelapse, size: 14, color: _statusColor)
                            : null,
                  ),
                ),
                        ...
                        Row(
                          children: [
                            Icon(
                              ...
                              size: 12,
                              color: _isOverdue ? TripReadyTheme.danger : TripReadyTheme.textMid,
                            ),
                            const SizedBox(width: 4),
                            Text(
                              fmt.format(task.dueDate!),
                              style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                color: _isOverdue ? TripReadyTheme.danger : null,
                                fontWeight: _isOverdue ? FontWeight.w700 : null,
                              ),
                            ),
                            if (_isOverdue) ...[
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: TripReadyTheme.danger.withOpacity(0.1),
                                  borderRadius: BorderRadius.circular(6),
                                ),
          ...
          children: [
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Task Name *',
                hintText: 'e.g. Book airport taxi',
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                    color: _dueDate != null ? TripReadyTheme.teal : TripReadyTheme.warmGrey,
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        _dueDate != null ? fmt.format(_dueDate!) : 'Set due date (optional)',
                        style: TextStyle(
                          color: _dueDate != null ? TripReadyTheme.textDark : TripReadyTheme.textLight,
                          fontSize: 14,
                        ),
                      ),
                    ),
            ...
            DropdownButtonFormField<TaskStatus>(
              ...
              items: TaskStatus.values.map((s) => DropdownMenuItem(
                value: s,
                child: Text(s == TaskStatus.inProgress ? 'In Progress' : s.statusLabel),
              )).toList(),
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: _isSaving
              ...
              : Text(_isEditing ? 'Update' : 'Add Task'),
        ),
      ],
    );
  }
